...
class Aidevix < Formula
  ...
  url "https://github.com/SUNNATBEE/sunnatbeeCLI/archive/refs/tags/v1.1.0.tar.gz"
  # TODO: reliz tarball'ining haqiqiy sha256'sini qo'ying (yuqoridagi izohga qarang).
